...
o43 = Item("Vegetetables", "", "Vegetables of various shapes and colors. You probably wouldn’t want to eat one of them.", "Vegetables of various shapes and colors. You probably wouldn’t want to eat one of them.", "All", "heavy", True, False)
o44 = Item("Megical Items", "", "Goblets, torches, it’s hard to tell what else. They have a purple glow and seem to phase in and out of existence.", "Goblets, torches, it’s hard to tell what else. They have a purple glow and seem to phase in and out of existence.", "All", "heavy", True, False)
